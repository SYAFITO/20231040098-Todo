                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm">
                            ...
                            <thead class="bg-gray-50 dark:bg-gray-700">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-semibold uppercase">Price</th>
                                    <th class="px-6 py-3 text-left text-xs font-semibold uppercase">Category</th>
                                    <th class="px-6 py-3 text-left text-xs font-semibold uppercase">Owner</th>
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-100 dark:divide-gray-700">
                                ...
                                @forelse($products as $product)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                                        ...
                                        {{-- PRICE --}}
                                        <td class="px-6 py-4 font-mono text-gray-700 dark:text-gray-200">
