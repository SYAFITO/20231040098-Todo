                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-product">Store a newly created resource in storage.</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-product--id-">
                                <a href="#endpoints-GETapi-product--id-">Display the specified resource.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>Example: <code>11613.31890586</code></p>
                    ...
                    <h2 id="endpoints-GETapi-product--id-">Display the specified resource.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/product/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
